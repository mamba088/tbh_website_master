...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function initPaging() {
        ...
        if (isTablet() && isInited) {
            ...
            const anchors = ['home', 'cases', 'about', 'services', 'partners', 'testimonials', 'blog', 'contacts']
            const labels = ['home', 'Selected works', 'about me', 'services', 'My clients', 'testimonials', 'My Latest', 'get in touch']
            ...
            function progressBar(index) {
                ...
                progressBar.style.height = 100 / 8 * index + '%';
            }
